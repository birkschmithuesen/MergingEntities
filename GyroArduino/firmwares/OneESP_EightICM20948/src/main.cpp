...
void setup(void) {
  ...
  socket[0].bias.hardiron_z = -8.63;
  socket[0].bias.magnetic_field = 39.93;
  socket[0].bias.softiron_1_1 = 1.022;
  socket[0].bias.softiron_1_2 = -0.011;
  socket[0].bias.softiron_1_3 = -0.001;
  socket[0].bias.softiron_2_1 = socket[0].bias.softiron_1_2;
  socket[0].bias.softiron_2_2 = 0.983;
  socket[0].bias.softiron_2_3 = -0.004;
  socket[0].bias.softiron_3_1 = socket[0].bias.softiron_1_3;
  socket[0].bias.softiron_3_2 = socket[0].bias.softiron_2_3;
  socket[0].bias.softiron_3_3 = 0.996;
  socket[1].label = "right_upper_arm";
  socket[1].channel = 1;
  socket[1].bias.hardiron_x = 16.43;
  socket[1].bias.hardiron_y = -1.75;
  socket[1].bias.hardiron_z = 33.61;
  socket[1].bias.magnetic_field = 39.59;
  socket[1].bias.softiron_1_1 = 1.011;
  socket[1].bias.softiron_1_2 = -0.009;
  socket[1].bias.softiron_1_3 = -0.013;
  socket[1].bias.softiron_2_1 = socket[1].bias.softiron_1_2;
  socket[1].bias.softiron_2_2 = 0.983;
  socket[1].bias.softiron_2_3 = -0.002;
  socket[1].bias.softiron_3_1 = socket[1].bias.softiron_1_3;
  socket[1].bias.softiron_3_2 = socket[1].bias.softiron_2_3;
  socket[1].bias.softiron_3_3 = 1.007;
  socket[2].label = "back";
  socket[2].channel = 2;
  socket[2].bias.hardiron_x = 7.69;
  socket[2].bias.hardiron_y = -4.59;
  socket[2].bias.hardiron_z = -21.54;
  socket[2].bias.magnetic_field = 38.88;
  socket[2].bias.softiron_1_1 = 1.016;
  socket[2].bias.softiron_1_2 = -0.004;
  socket[2].bias.softiron_1_3 = 0.006;
  socket[2].bias.softiron_2_1 = socket[2].bias.softiron_1_2;
  socket[2].bias.softiron_2_2 = 0.982;
  socket[2].bias.softiron_2_3 = 0.003;
  socket[2].bias.softiron_3_1 = socket[2].bias.softiron_1_3;
  socket[2].bias.softiron_3_2 = socket[2].bias.softiron_2_3;
  socket[2].bias.softiron_3_3 = 1.003;
  socket[3].label = "right_foot";
  socket[3].channel = 3;
  socket[3].bias.hardiron_x = -32.53;
  socket[3].bias.hardiron_y = -7.26;
  socket[3].bias.hardiron_z = -30.3;
  socket[3].bias.magnetic_field = 40.40;
  socket[3].bias.softiron_1_1 = 1.028;
  socket[3].bias.softiron_1_2 = -0.03;
  socket[3].bias.softiron_1_3 = 0.005;
  socket[3].bias.softiron_2_1 = socket[3].bias.softiron_1_2;
  socket[3].bias.softiron_2_2 = 0.977;
  socket[3].bias.softiron_2_3 = -0.003;
  socket[3].bias.softiron_3_1 = socket[3].bias.softiron_1_3;
  socket[3].bias.softiron_3_2 = socket[3].bias.softiron_2_3;
  socket[3].bias.softiron_3_3 = 0.996;
  socket[4].label = "left_lower_arm";
  socket[4].channel = 4;
  socket[4].bias.hardiron_x = -25.52;
  socket[4].bias.hardiron_y = -19.57;
  socket[4].bias.hardiron_z = -7.83;
  socket[4].bias.magnetic_field = 50.56;
  socket[4].bias.softiron_1_1 = 1.028;
  socket[4].bias.softiron_1_2 = 0.19;
  socket[4].bias.softiron_1_3 = -0.006;
  socket[4].bias.softiron_2_1 = socket[4].bias.softiron_1_2;
  socket[4].bias.softiron_2_2 = 0.974;
  socket[4].bias.softiron_2_3 = 0.001;
  socket[4].bias.softiron_3_1 = socket[4].bias.softiron_1_3;
  socket[4].bias.softiron_3_2 = socket[4].bias.softiron_2_3;
